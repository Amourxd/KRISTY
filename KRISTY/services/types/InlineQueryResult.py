...
#  CREDITS:
#       THE CODE BELOW THIS LINE IS WRITTEN BY https://github.com/Xdarnav. [https://t.me/Cute_arnavsingh]
#       https://github.com/Xdarnav/pyrogram/blob/inline/pyrogram/types/inline_mode/inline_query_result_cached_document.py
